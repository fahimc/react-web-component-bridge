...
const columns = ["Backlog", "Selected", "In Progress", "Done"];
...
function JiraApp(props) {
    ...
    return (h("section", { className: "jira-app" },
        h("aside", { className: "jira-left" },
            h("strong", null, "RWCB Project"),
            h("span", null, "Kanban board"),
            h("span", null, "Releases"),
            h("span", null, "Reports"),
            h("span", null, "Project settings")),
        h("main", null,
            h("header", { className: "jira-header" },
                h("div", null,
                    h("p", { className: "origin" }, "Jira Clone app pattern"),
                    h("h2", null, "React compiler launch board")),
                h("button", null, "Create issue")),
            h("div", { className: "jira-controls" },
                h("input", { "aria-label": "Search issues", placeholder: "Search issues", value: state.search, onInput: (event) => dispatch({ type: "search", value: event.currentTarget.value }) }),
                h("select", { value: state.priority, onChange: (event) => dispatch({ type: "priority", value: event.currentTarget.value }) },
                    h("option", null, "All"),
                    h("option", null, "High"),
                    h("option", null, "Medium"),
                    h("option", null, "Low"))),
            h("section", { className: "jira-columns" }, columns.map((column) => (h("article", { className: "jira-column" },
                h("header", null,
                    h("strong", null, column),
                    h("span", null, visible.filter((issue) => issue.status === column).length)),
                visible
                    .filter((issue) => issue.status === column)
                    .map((issue) => (h("button", { className: state.selectedKey === issue.key ? "jira-card selected" : "jira-card", onClick: () => {
                    ...
                    h("small", null,
                        ...
                        issue.estimate,
                        " pts"))))))))),
        h("aside", { className: "jira-detail" },
            h("p", { className: "origin" }, "Issue detail"),
            h("h3", null, selected.key),
            ...
            h("dl", null,
                ...
                h("div", null,
                    h("dt", null, "Priority"),
                    h("dd", null, selected.priority)),
                h("div", null,
                    h("dt", null, "Assignee"),
                    h("dd", null, selected.assignee)),
                h("div", null,
                    h("dt", null, "Estimate"),
                    h("dd", null,
                        selected.estimate,
