# @fahimc/react-web-component-bridge
...
The package also exports a React-compatible authoring facade at `@fahimc/react-web-component-bridge/react` for inline `defineComponentTag` metadata.
